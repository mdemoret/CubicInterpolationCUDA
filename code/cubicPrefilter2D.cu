...
template<typename floatN>
void CubicBSplinePrefilter2D(floatN* image, unsigned int pitch, unsigned int width, unsigned int height)
{
...
template void CubicBSplinePrefilter2D<float>(float* image, unsigned int pitch, unsigned int width, unsigned int height);
